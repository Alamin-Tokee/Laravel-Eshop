<!-- <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="#">Kaalahari</a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6">
        <p class="small"><i class="bx bx-envelope"></i> info@kaalahari.com | <i class="bx bx-phone"></i> +880-1718888888
        </p>
      </div>
...
<nav class="navbar navbar-expand-md navbar-light bg-light main-menu" style="box-shadow:none">
  <div class="container">
    ...
    <a class="navbar-brand" href="#">
      <h4 class="font-weight-bold">kaalahari</h4>
    </a>

    <ul class="navbar-nav ml-auto d-block d-md-none">
      <li class="nav-item">
        <a class="btn btn-link" href="#"><i class="fa fa-item icon-single"></i> <span class="badge badge-danger">3</span></a>
      </li>
    </ul>
    ...
    <div class="collapse navbar-collapse">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="btn btn-link" href="#"><i class="fa fa-shopping-cart icon-single"></i> <span class="badge badge-danger">3</span></a>
        </li>
        <li class="nav-item ml-md-3">
          <a class="btn btn-primary" href="#"><i class="fa fa-user-circle mr-1"></i> Log In / Register</a>
        </li>
      </ul>
    </div>
